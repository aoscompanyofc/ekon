        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-6 bg-white/[0.03] p-8 md:p-12 rounded-3xl border border-white/10 relative">
          ...
          <div className="text-center md:text-left max-w-xl relative z-10">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight text-white leading-tight mb-3">
              Pare de pagar caro na sua<br />conta de luz.
            </h2>
          ...
          <div className="w-full md:w-auto relative z-10 flex flex-col items-center gap-3 flex-shrink-0">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 whitespace-nowrap px-8 py-4 rounded-full bg-ekon-green hover:bg-ekon-green-light text-ekon-purple-dark font-extrabold text-base tracking-wider shadow-[0_6px_24px_rgba(0,230,118,0.4)] hover:shadow-[0_8px_30px_rgba(0,230,118,0.6)] transition-all duration-300"
            >
